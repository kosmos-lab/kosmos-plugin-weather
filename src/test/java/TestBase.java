...
public class TestBase {
    ...
    public static void prepare() {
        ...
        try {
            ...
            FileUtils.writeToFile(KosmoSController.getFile("users.json", RunMode.TEST), new JSONObject().put("admin", clientAdmin.getPassword()).put("user", clientUser.getPassword()).toString());
